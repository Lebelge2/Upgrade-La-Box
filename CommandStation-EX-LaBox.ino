...
void IRAM_ATTR timer_isr_CutOut() {
  ...
  switch (p) {
    ...
    case 2:
      ...
      break;
    case 3:
      gpio_matrix_out(GPIO_NUM_27, RMT_SIG_OUT0_IDX + canal, true, false);    // * Reconnecte la pin 27 au module RMT en inverse
      gpio_matrix_out(GPIO_NUM_33, RMT_SIG_OUT0_IDX + canal, true, false);    // * Reconnecte la pin 33 au module RMT en inverse
      break;
    default:
      gpio_matrix_out(GPIO_NUM_33, RMT_SIG_OUT0_IDX + canal, false, false);   // * Reconnecte la pin 33 au module RMT
